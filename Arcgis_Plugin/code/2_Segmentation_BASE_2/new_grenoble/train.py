...
def main():
    ...
    if modelpath:
        ...
        model = factory.model_factory(net_type, num_classes, feature_extract, fine_tunning)
    ...
    dataloaders_dict = {}
    dataset = dataloader.RS_Loader_Semantic(dataset_dir, num_classes, mode='train')
    ...
    dataset_val = dataloader.RS_Loader_Semantic(dataset_dir, num_classes, mode='val')
    ...
    final_model, val_history = factory.train(model, dataloaders_dict, criterion, optimizer,
                                             epochs, early_stop, tensor_board, net_type, scheduler, opt_type, list_classes)
    ...
    torch.save(final_model, os.path.join(base_output, net_type + '_final_model_ft'))
